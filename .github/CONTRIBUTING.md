...
The `masmainter` branch is protected, because the main way people get this boilerplate is through `git clone`. Cloning a repo downloads the `main` branch, so there is no room for error or breakages there.
...
By contributing your code, you agree to license your contribution under the [MIT License](https://github.com/postcss/postcss.org/blob/main/LICENSE).
